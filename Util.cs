                ...
                for (int i = 0; i < staffData.Count; i++)
                {
                    ...
                    staves.Add(
                        new Weapon(staffTexture, projectileTexture)
                        {
                            ...
                            IsUntiered = staffData[i].IsUntiered,
                            ...
                            RadialShotCount = staffData[i].RadialShotCount,
                ...
                for (int i = 0; i < wandData.Count; i++)
                {
                    ...
                    wands.Add(
                        new Weapon(wandTexture, projectileTexture)
                        {
                            ...
                            IsUntiered = wandData[i].IsUntiered,
                            ...
                            Amplitude = wandData[i].Amplitude,
                            Frequency = wandData[i].Frequency,
